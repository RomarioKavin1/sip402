...
## What it is
sip402 — "Session-Initiated Payments. Open a tab, pay by the sip." The first on-chain, capital-backed binding of x402's `batch-settlement` scheme. One MetaMask ERC-7715 Advanced Permission grants a capped, periodic USDC allowance; an agent spends within it; the **chain** enforces the cap and revocation. No trusted custodian.
...
- **The one idea:** *x402 prices the request; sip402 prices the delivery.* On-chain *enforcement*, off-chain *delivery*.
